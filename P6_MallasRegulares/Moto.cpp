 ...
 */
Moto::Moto(string mat, int estatus, double lat, double longt, float bat) : id(mat) {
...
/**
 * @brief Recarga la moto en un punto de recarga
 * @param pr - Punto de recarga en el que se recarga la moto
 */
void Moto::recargar(PuntoRecarga *pr) {
    precarga = pr;
    setPorcentajeBateria(100);
}
