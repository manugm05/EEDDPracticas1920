...
int main(int argc, char** argv) {
    ...
    do {
        ...
        cout << "2) Bucar cliente por DNI. (necesario para localizar moto)\n";
        cout << "3) Localizar moto cercana del cliente buscado, desbloquearla y crear itirenario\n";
        cout << "4) Terminar Trayecto (necesario empezar un trayecto antes)\n";
            ...
            case 2:
                if (usuarioactivo) cout << "\n[!]Ya has activado un usuario\n";
                    ...
                    if (usuario) {
                        ...
                        cout << "Puntos totales: " << usuario->getPuntos() << "/10" << endl;
                        char sn = '?';
                        while (sn != 's' && sn != 'n') {
